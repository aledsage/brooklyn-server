...
import org.apache.brooklyn.core.location.dynamic.clocker.StubInfrastructureLocation;
import org.apache.brooklyn.core.location.dynamic.clocker.StubResolver.StubLocationConstructor;
...
public class ServerPoolLocationResolver implements LocationResolver {
    ...
    public LocationSpec newLocationSpecFromString(String spec, Map locationFlags, LocationRegistry registry) {
        ...
        return LocationSpec.create(ServerPoolLocation.class)
                .configure(StubLocationConstructor.LOCATION, poolLoc)
                .configure(Config.SPECIAL_CONSTRUCTOR, StubLocationConstructor.class);
    }
    
    @Beta
    public static class ServerPoolLocationConstructor implements SpecialBrooklynObjectConstructor {
